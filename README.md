...
This has been built in Create React App, but the parsing aspect could easily be repackaged as an NPM package - hence the reason for it being in an utility
